namespace PetByte.CustomCalendars {
    class CalendarInfo {
        ...
        public Func<int, bool> leapDaysCalculator { get; set; }

        public CalendarInfo(string calendarName, List<string> monthNames, List<int> monthDurations, Dictionary<int, int> leapDays, int gregorianStartDay, int gregorianStartMonth, int gregorianYearOffset, Func<int, bool> leapDaysCalculator) {
            ...
            this.leapDaysCalculator = leapDaysCalculator;
        }
    }
}